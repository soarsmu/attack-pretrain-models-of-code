...
```
python3 bertattack.py --data_path data_defense/imdb_1k.tsv --mlm_path bert-base-uncased --tgt_path models/my_imdb_model --use_sim_mat 0 --output_dir data_defense/imdb_logs_gpu1.tsv --num_label 2 --use_bpe 1 --k 48 --start 0 --end 1000 --threshold_pred_score 0
```
