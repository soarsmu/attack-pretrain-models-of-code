...
# "Raw" refers to source code token sequences
# "Rep" refers to the token index sequences (converting the token into index according to the vocabulary)
# "Label" refers to the annotation
# "tree" to a complete syntax tree generated by a tool implemented by pycparser (see here https://github.com/LC-John/Py-CParser)
...
def dataset(dir='./tmp', tgt='./dataset/oj.pkl.gz',
